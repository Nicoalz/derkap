    ...
    <div>
      <div className='relative'>
        <input {...props} type={inputType}
          ...
          className={cn(" bg-white rounded-[10px] text-sm pl-[18px] text-black pr-[18px]  border-[1px] w-full border-transparent focus:outline-none shadow-base py-[12px]", className, { "border-red-500": errorMsg }, { "pr-[50px]": type === "password" })} />
