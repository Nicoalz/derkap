  ...
  return (
    <div className='p-6 flex flex-col items-center justify-center'>
      ...
      <div className="w-full p-6 bg-gray-100 rounded-lg flex flex-col items-center justify-center mb-4">
        ...
        <p className="text-gray-600 mb-2">Sélectionner une image pour illustrer votre groupe</p>
        <label htmlFor="image-upload" className="cursor-pointer bg-purple-600 text-white py-2 px-4 rounded-lg">
          Choisir une image
        </label>
        <input
          id="image-upload"
