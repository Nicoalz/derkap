...
const ProfileScreen = ({ id }: { id?: string }) => {
  ...
  if (isLoading) {
    return <div className="w-full h-screen flex flex-col items-center justify-start">
  ...
  if (!userData) {
    return <div className="w-full h-screen flex flex-col items-center justify-start">
      ...
      <p className='p-5 text-center'>Aucun utilisateur ne correpsond à votre recherche...</p>
    </div>
  }
