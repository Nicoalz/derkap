...
const BottomNavbar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-6 w-[90%] left-1/2 transform -translate-x-1/2 bg-white/60 bg-blur text-black/70 rounded-lg shadow-lg flex justify-around items-center p-4">
      {tabs.map((tab, index) => {
