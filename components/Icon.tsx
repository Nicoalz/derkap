...
export function Home({ isActive, className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={isActive ? 'black' : 'none'} stroke="currentColor" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round">
...
export function Kaps({ isActive, className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={isActive ? 'black' : 'none'} stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round">
